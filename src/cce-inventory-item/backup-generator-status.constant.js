...
(function() {
    ...
    /**
     * @ngdoc object
     * @name cce-inventory-item.BACKUP_GENERATOR_STATUS
     *
     * @description
     * Stores the list of all available backup generator statuses and a method to get their
     * labels.
     */
    angular
        .module('cce-inventory-item')
        .constant('BACKUP_GENERATOR_STATUS', BACKUP_GENERATOR_STATUS());

    BACKUP_GENERATOR_STATUS.$inject = [];

    function BACKUP_GENERATOR_STATUS() {
        ...
        return BACKUP_GENERATOR_STATUS;

        /**
         * @ngdoc method
         * @methodOf cce-inventory-item.BACKUP_GENERATOR_STATUS
         * @name getLabel
         *
         * @description
        ...
        function getStatuses() {
            return [
                BACKUP_GENERATOR_STATUS.YES,
                BACKUP_GENERATOR_STATUS.NO,
                BACKUP_GENERATOR_STATUS.UNKNOWN,
                BACKUP_GENERATOR_STATUS.NOT_APPLICABLE
            ];
        }
