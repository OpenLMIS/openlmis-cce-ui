...
describe('openlmis.cce.inventory.item.transfer state', function() {
    ...
    beforeEach(function() {
        ...
        state = $state.get('openlmis.cce.inventory.item.transfer');
        $stateParams = {};
    ...
    it('should accept inventoryItemId', function() {
        expect(state.url.indexOf('transfer')).toBeGreaterThan(-1);
    ...
    describe('modal', function() {
        ...
        beforeEach(function() {
            state.onEnter(openlmisModalService, inventoryItem, canTransfer);
